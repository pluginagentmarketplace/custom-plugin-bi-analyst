...
This guide provides comprehensive documentation for the **power-bi** skill in the custom-plugin-bi-analyst plugin.
...
```bash
# Invoke the skill
claude "power-bi - [your task description]"

# Example
claude "power-bi - analyze the current implementation"
```
...
def implement_power_bi(input_data):
    """
    Implement power-bi functionality.
