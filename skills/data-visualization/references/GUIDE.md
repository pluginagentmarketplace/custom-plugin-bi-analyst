...
This guide provides comprehensive documentation for the **data-visualization** skill in the custom-plugin-bi-analyst plugin.
...
```bash
# Invoke the skill
claude "data-visualization - [your task description]"

# Example
claude "data-visualization - analyze the current implementation"
```
...
def implement_data_visualization(input_data):
    """
