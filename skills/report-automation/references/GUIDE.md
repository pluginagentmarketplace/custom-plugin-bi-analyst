...
This guide provides comprehensive documentation for the **report-automation** skill in the custom-plugin-bi-analyst plugin.
...
```bash
# Invoke the skill
claude "report-automation - [your task description]"

# Example
claude "report-automation - analyze the current implementation"
```
...
def implement_report_automation(input_data):
    """
    Implement report-automation functionality.
