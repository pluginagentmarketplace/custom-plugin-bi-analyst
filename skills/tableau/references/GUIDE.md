...
This guide provides comprehensive documentation for the **tableau** skill in the custom-plugin-bi-analyst plugin.
...
```bash
# Invoke the skill
claude "tableau - [your task description]"

# Example
claude "tableau - analyze the current implementation"
```
...
def implement_tableau(input_data):
    """
    Implement tableau functionality.
