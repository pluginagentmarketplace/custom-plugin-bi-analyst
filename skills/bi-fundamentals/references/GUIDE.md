# Bi Fundamentals Guide

## Overview

This guide provides comprehensive documentation for the **bi-fundamentals** skill in the custom-plugin-bi-analyst plugin.
...
```bash
# Invoke the skill
claude "bi-fundamentals - [your task description]"

# Example
claude "bi-fundamentals - analyze the current implementation"
```
...
def implement_bi_fundamentals(input_data):
    """
    Implement bi-fundamentals functionality.
