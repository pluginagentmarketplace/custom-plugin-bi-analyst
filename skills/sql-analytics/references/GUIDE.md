...
This guide provides comprehensive documentation for the **sql-analytics** skill in the custom-plugin-bi-analyst plugin.
...
```bash
# Invoke the skill
claude "sql-analytics - [your task description]"

# Example
claude "sql-analytics - analyze the current implementation"
```
...
def implement_sql_analytics(input_data):
    """
    Implement sql-analytics functionality.
